...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,python,sklearn,anaconda,postgres,html,css,js,mongodb,git,github,vscode,matlab,arduino,django,opencv,postgres,pytorch,tensorflow,&perline=13)](#)
